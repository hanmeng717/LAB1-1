		...
		if (just) {
			for (int i = 0; i < Exp.length(); i++) {
				...
				if (num == 2) {
					just = false;
					break;
				} else if (i > 0 && String.valueOf(Exp.charAt(i)).matches(rejust2)
						&& String.valueOf(Exp.charAt(i - 1)).matches(rejust3)) {
					just = false;
					break;
				} else if (i > 0 && String.valueOf(Exp.charAt(i)).matches(rejust3)
						&& String.valueOf(Exp.charAt(i - 1)).matches(rejust2)) {
					just = false;
					break;
				} else if (i > 0 && String.valueOf(Exp.charAt(i)).matches(rejust2)
						&& String.valueOf(Exp.charAt(i - 1)).matches(rejust2)) {
					...
					just = false;
					break;
				} else if (i > 0 && String.valueOf(Exp.charAt(i)).matches(rejust4)
						&& String.valueOf(Exp.charAt(i - 1)).matches(rejust1)) {
					just = false;
					break;
				} else if (i > 0 && String.valueOf(Exp.charAt(i)).matches(rejust1)
						&& String.valueOf(Exp.charAt(i - 1)).matches(rejust4)) {
					just = false;
					break;
				}
			}
